...
if($_SERVER['REQUEST_METHOD']=="POST"){
    if(empty($_POST['name']) || empty($_POST['lastname'])  || empty($_POST['telnumber']) || empty($_POST['adress']) || empty($_POST['username']) || empty($_POST['shoesize'])){
        $error = "netinka";
...
//        }
        ...
        {
            $sql = " INSERT INTO linuxai (name, lastname, telnumber, adress, username, shoesize) VALUES ('".$_POST["name"]."','".$_POST["lastname"]."','".$_POST["telnumber"]."','".$_POST["adress"]."','".$_POST["username"]."','".$_POST["shoesize"]."')";
